        ...
        while True:
            ...
            if contours:
                ...
                if contours:
                    ...
                    valkey_client.set("width", width)
                    valkey_client.set("length", length)
                    ...
                    # cv2.circle(object_image, (max_location[0], max_location[1]), 5, (0, 0, 255), -1)
                    # cv2.circle(object_image, (min_location[0], min_location[1]), 5, (0, 255, 0), -1)
                    # cv2.imshow("Depth Area", np.uint8(cv2.normalize(depth_area, None, 0, 255, cv2.NORM_MINMAX)))
                    # print((max_value - min_value) * 1000)
                    valkey_client.set("height", (max_value - min_value) * 1000)
